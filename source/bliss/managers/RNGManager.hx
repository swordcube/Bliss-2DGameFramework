 ...
 * 
 * @see https://github.com/HaxeFlixel/flixel/blob/master/flixel/math/RNGManager.hx
 */
class RNGManager {
	/**
	...
	/**
	 * Create a new RNGManager object.
	 *
	 * @param	InitialSeed  The first seed of this RNGManager object. If ignored, a random seed will be generated.
	 */
	 ...
	 * See this image: https://github.com/HaxeFlixel/flixel-demos/blob/dev/Performance/RNGManager/normaldistribution.png
	 *
	 ...
	 */
	public function color(?Min:BlissColor, ?Max:BlissColor, ?Alpha:Int, GreyScale:Bool = false):BlissColor {
		var red:Int;
		var green:Int;
		var blue:Int;
		var alpha:Int;
        ...
        var retColor:BlissColor = new BlissColor();
        retColor.red = red;
        retColor.green = green;
        retColor.blue = blue;
        retColor.alpha = alpha;
		return retColor;
	}
